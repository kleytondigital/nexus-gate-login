...
BEGIN
  -- Inserir cliente
  INSERT INTO public.clientes (nome, cnpj_principal, email, telefone, endereco, created_by)
  ...
  INSERT INTO public.cnpjs (cliente_id, cnpj, razao_social, nome_fantasia, endereco)
